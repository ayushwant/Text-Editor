...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
		...
		List<String> pat = new ArrayList<String>();
		 pat = getTokens("[a-zA-Z 0-9[^!.?]]+");
		//System.out.println("pat = " +pat);
		/*int i=0;
		for(String s : pat)
		{
		System.out.println(i+ "hollllo" +s);
		}*/
        return pat.size();
	...
	public int getNumSyllables()
	{
		...
		/*List<String> pat = new ArrayList<String>();
		 pat = getTokens("[aeiouy]+");
        */
		int total=0;
		List<String> word = getTokens("[a-zA-Z]+");
		//List<String> pat = getNumWords().word;
		for(String s : word)
		{
			/*List<String> pat = getTokensWord("[aeiouy]+",s);
			total+=pat.size();*/
			total+=countSyllables(s);
