...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		for (int numToCheck = start; numToCheck < numSteps*increment + start; numToCheck += increment)
		{
			...
			BasicDocument b = new BasicDocument(s);
			double fs1 = b.getFleschScore();
			long basicEnd =  System.nanoTime();
			double basicTime = (basicEnd-basicStart)/100000000.0;
			System.out.print(basicTime +"\t");
			
			long effStart = System.nanoTime();
			EfficientDocument e = new EfficientDocument(s);
			double fs2 = e.getFleschScore();
			long effEnd =  System.nanoTime();
			double effTime = (effEnd-effStart)/100000000.0;
